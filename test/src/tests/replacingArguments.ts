...
// const DELAY = 10;
//
// const MSG = "Extending suit arguments.";
//
...
//
//                 const methodArguments = [function() {
//                     result.push({
...
//             this.AnotherSuit = mod();
//
//             const beforeResult: any[] = this.beforeResult = [];
//             const afterResult: any[] = this.afterResult = [];
//             const itResult: any[] = this.itResult = [];
//
